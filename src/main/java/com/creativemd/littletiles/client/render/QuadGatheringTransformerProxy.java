...
public abstract class QuadGatheringTransformerProxy implements IVertexConsumer
{
    protected IVertexConsumer parent;
    protected VertexFormatProxy format;
    ...
    @Override
    public VertexFormatProxy getVertexFormat()
    {
        return format;
    }
