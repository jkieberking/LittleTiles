...
public class LittleRenderChunkProxy {

//    protected int lastRenderIndex = LittleChunkDispatcherProxy.currentRenderState;
...
//
//    private LinkedHashMap<BlockPos, TileEntityLittleTilesProxy> tileEntities = new LinkedHashMap<>();
//    /** if one of the blocks has been modified, which requires the chunk cache to be uploaded again */
//    private boolean modified = false;
//    private boolean complete = false;
//
//    public LittleRenderChunkProxy(BlockPos pos) {
//        this.pos = pos;
