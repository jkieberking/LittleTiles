...
public class VertexFormatElementProxy
{
    ...
    private final VertexFormatElementProxy.EnumType type;
    private final VertexFormatElementProxy.EnumUsage usage;
    private final int index;
    private final int elementCount;

    public VertexFormatElementProxy(int indexIn, VertexFormatElementProxy.EnumType typeIn, VertexFormatElementProxy.EnumUsage usageIn, int count)
    {
        ...
        else
        {
            ...
            this.usage = VertexFormatElementProxy.EnumUsage.UV;
        }
    ...
    private final boolean isFirstOrUV(int p_177372_1_, VertexFormatElementProxy.EnumUsage p_177372_2_)
    {
        return p_177372_1_ == 0 || p_177372_2_ == VertexFormatElementProxy.EnumUsage.UV;
    }

    public final VertexFormatElementProxy.EnumType getType()
    {
        return this.type;
    }

    public final VertexFormatElementProxy.EnumUsage getUsage()
    {
        return this.usage;
    }
    ...
    {
        return this.usage == VertexFormatElementProxy.EnumUsage.POSITION;
    }
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        {
            VertexFormatElementProxy vertexformatelement = (VertexFormatElementProxy)p_equals_1_;
