...
public class ForgeHooksClientProxy
{
...
//
    public static void preDraw(VertexFormatElementProxy.EnumUsage attrType, VertexFormatProxy format, int element, int stride, ByteBuffer buffer)
    {
        VertexFormatElementProxy attr = format.getElement(element);
        ...
        switch(attrType)
        {
            ...
            case GENERIC:
                ...
                break;
            default:
                FMLLog.log(Level.FATAL, "Unimplemented vanilla attribute upload: {}", attrType.getDisplayName());
        }
    }

    public static void postDraw(VertexFormatElementProxy.EnumUsage attrType, VertexFormatProxy format, int element, int stride, ByteBuffer buffer)
    {
        VertexFormatElementProxy attr = format.getElement(element);
        switch(attrType)
        {
            ...
            case COLOR:
                ...
                // @TODO is this needed?
                //  there was a comment in the forge code: "is this really needed?"
                // GL11.resetColor();
                break;
            case UV:
                OpenGlHelper.setClientActiveTexture(OpenGlHelper.defaultTexUnit + attr.getIndex());
