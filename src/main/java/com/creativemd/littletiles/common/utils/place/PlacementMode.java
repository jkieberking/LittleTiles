...
//            return PreviewMode.LINES;
    ...
    public abstract List<LittleTile> placeTile(Placement placement, Placement.PlacementBlock block, IParentTileList parent/*, LittleStructure structure,*/, LittleTile tile, boolean requiresCollisionTest) throws LittleActionException;
