...
//        setCreativeTab(LittleTiles.littleTab);
    ...
    protected String getIconString() {
        return LittleTiles.modid + ":LTGrabber";
    }
...
//    @Override
    @SideOnly(Side.CLIENT)
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean advanced, List<String> tooltip) {
...
//        getMode(stack).onClickBlock(world, player, stack, movingObjectPosition);
//        return true;
//    }
...
//        return getMode(stack).onRightClick(world, player, stack, movingObjectPosition);
//    }

//    @Override
//    public boolean onMouseWheelClickBlock(World world, EntityPlayer player, ItemStack stack, PlacementPosition position, MovingObjectPosition movingObjectPosition) {
//        return getMode(stack).onMouseWheelClickBlock(world, player, stack, movingObjectPosition);
//    }
...
//    }
    ...
    public static abstract class GrabberMode {
        ...
        @SideOnly(Side.CLIENT)
        public void onClickBlock(@Nullable World world, EntityPlayer player, ItemStack stack, @Nullable MovingObjectPosition movingObjectPosition) {

        }

        @SideOnly(Side.CLIENT)
        public boolean onRightClick(World world, EntityPlayer player, ItemStack stack, MovingObjectPosition movingObjectPosition) {
            return true;
        }

        @SideOnly(Side.CLIENT)
        public abstract boolean onMouseWheelClickBlock(World world, EntityPlayer player, ItemStack stack, MovingObjectPosition movingObjectPosition);
...
//        public abstract void littleBlockAction(World world, TileEntityLittleTiles te, LittleTile tile, ItemStack stack, BlockPos pos, NBTTagCompound nbt);
    ...
    public static abstract class SimpleMode extends GrabberMode {
        ...
        @Override
        @SideOnly(Side.CLIENT)
        public boolean onMouseWheelClickBlock(World world, EntityPlayer player, ItemStack stack, MovingObjectPosition movingObjectPosition) {
//            @TODO implement type chooser
...
//        @Override
//        public void littleBlockAction(World world, TileEntityLittleTilesProxy te, LittleTile tile, ItemStack stack, BlockPos pos, NBTTagCompound nbt) {
//            LittlePreview oldPreview = getPreview(stack);
...
//
            ...
            // @TODO implement selected type of block thingy
//                    GuiStackSelectorAll selector = (GuiStackSelectorAll) get("preview");
//                    ItemStack selected = selector.getSelected();
//                    if (!selected.isEmpty() && selected.getItem() && selected instanceof ItemBlock) {
...
//            tooltip.add(TooltipUtils.printRGB(preview.hasColor() ? preview.getColor() : ColorUtils.WHITE));
    ...
    public static class PlacePreviewMode extends GrabberMode {
        ...
        @SideOnly(Side.CLIENT)
        public boolean onMouseWheelClickBlock(World world, EntityPlayer player, ItemStack stack, MovingObjectPosition movingObjectPosition) {
            // @TODO middle mouse click choose block type
//            IBlockState state = world.getBlockState(result.getBlockPos());
