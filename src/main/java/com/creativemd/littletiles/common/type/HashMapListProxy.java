...
public class HashMapListProxy<K, V> {

    private LinkedHashMap<K, ArrayList<V>> keys;

    public HashMapListProxy() {
        this.keys = new LinkedHashMap<>();
    }

    public HashMapListProxy(HashMapListProxy<K, V> object) {
        this();
        addAll(object);
    }
    ...
    public void addAll(HashMapListProxy<K, V> map) {
