...
public class RotationUtilsProxy {
    ...
    public static String[] getHorizontalFacingNames() {
        if (horizontalFacingNames == null) {
            ...
            for (int i = 0; i < horizontalFacingNames.length; i++) {
                horizontalFacingNames[i] = EnumFacingProxy.getHorizontal(i).getName();
            }
        }
    ...
    public static String[] getFacingNames() {
        if (facingNames == null) {
            ...
            for (int i = 0; i < facingNames.length; i++) {
                facingNames[i] = EnumFacingProxy.getFront(i).getName();
            }
        }
        return facingNames;
    }
    ...
    public static EnumFacingProxy.Axis getThird(EnumFacingProxy.Axis one, EnumFacingProxy.Axis two) {
        switch (one) {
        case X:
            if (two == EnumFacingProxy.Axis.Y)
                return EnumFacingProxy.Axis.Z;
            return EnumFacingProxy.Axis.Y;
        case Y:
            if (two == EnumFacingProxy.Axis.X)
                return EnumFacingProxy.Axis.Z;
    ...
    public static EnumFacingProxy.Axis getTwo(EnumFacingProxy.Axis axis) {
        switch (axis) {
        case X:
            return EnumFacingProxy.Axis.Z;
        case Y:
